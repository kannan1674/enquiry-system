...
const HeaderLogo = () => {
  ...
  return (
    <div className="flex items-stretch gap-1.5 lg:gap-10 grow ">
      {/* Show hamburger menu first on mobile */}
      {isMobile && (
      ...
      <div className="flex items-center gap-2.5">
        ...
        <h3 className="text-mono text-lg font-medium" style={{ marginLeft: '7px' }}>
          Fancy Parivahan
        </h3>
      </div>

      {!isMobile && (
        <div className="flex-1 flex justify-center"><MegaMenu /></div>
      )}
    </div>
  );
};
